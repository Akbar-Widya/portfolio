const socialLinks = [
   {
      href: "https://www.github.com/Akbar-Widya",
      icon: (
         <svg
            width="24"
            height="24"
   ...
   return (
      <section id="contact" className="section">
         <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
               ...
               <div className="flex items-center gap-2 mt-auto">
                  {socialLinks.map(({ href, icon }, key) => (
                     ...
                     ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80"
                     >
                        {icon}
                     </a>
                  ))}
            ...
            <form action="https://getform.io/f/aejexjyb" method="POST" className="xl:pl-10 2xl:pl-20">
